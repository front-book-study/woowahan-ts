...
모달 창을 화면에 그릴 때 다양한 액션에 따라 인자의 개수 or 타입을 일일이 명시하기 힘들 수 있음<br> → `any` 타입을 사용해 다양한 액션 함수 전달 가능
...
<h2 style="color:#178c7c">5. 맵드 타입(Mapped Types)</h2>
